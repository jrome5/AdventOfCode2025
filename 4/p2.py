'''
Examine map of papers. count if the surrounding 8 squares have less than 4 papers. do this iteratively
'''
def count_valid(lines):
    valid_count = 0
    kernel = []
    one_more_cycle = True
    while one_more_cycle:
        ...
        one_more_cycle = len(removed_rolls) > 0
